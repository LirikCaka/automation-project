...
public class LoginStepDefs {
    ...
    public void user_enters_human_resource_password() {
        loginPage.password.sendKeys(ConfigurationReader.getProperty("HR_password") + Keys.ENTER);
    ...
    public void user_enters_helpdesk_username() {
        loginPage.userName.sendKeys(ConfigurationReader.getProperty("Helpdesk_username"));

    }

    @When("user enters helpdesk password")
    public void user_enters_helpdesk_password() {
        loginPage.password.sendKeys(ConfigurationReader.getProperty("Helpdesk_password") + Keys.ENTER);
    ...
    public void user_enters_marketing_password() {
        loginPage.password.sendKeys(ConfigurationReader.getProperty("Marketing_password") + Keys.ENTER);
